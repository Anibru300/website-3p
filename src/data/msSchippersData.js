...
export const msSchippersProducts = [
  { codigo: '806012', nombre: 'Acomplamiento inox 2x1/4" rosca macho KEW', stock: 49, categoria: 'equipo' },
  { codigo: '4310099', nombre: 'Conexión rRacor KEW 1/4" rosca exterior MACHO pipa', stock: 10, categoria: 'equipo' },
  { codigo: '4309532', nombre: 'DIGI DOSER DI-O 10', stock: 2, categoria: 'equipo' },
  { codigo: '44309530', nombre: 'DIGI DOSER DI-O 2', stock: 11, categoria: 'equipo' },
  { codigo: '4309531', nombre: 'DIGI DOSER DI-O 5', stock: 3, categoria: 'equipo' },
  { codigo: '0807075C', nombre: 'ESPUMADORA C/ CONEX RAPID LS10', stock: 6, categoria: 'equipo' },
  { codigo: '808017', nombre: 'GREEN LINE 1.3', stock: 4, categoria: 'equipo' },
  { codigo: '807020', nombre: 'HY BAG PISTOLAESPUMADORA', stock: 5, categoria: 'equipo' },
  { codigo: 'CONEXRAPID', nombre: 'MS Conexión rápida', stock: 0, categoria: 'equipo' },
  { codigo: '0807173', nombre: 'MS Rosca de 0.7 MM', stock: 1, categoria: 'equipo' },
  { codigo: '0807174', nombre: 'MS Rosca de 0.8 MM', stock: 1, categoria: 'equipo' },
  { codigo: '0807175', nombre: 'MS Rosca de 0.9 MM', stock: 1, categoria: 'equipo' },
  ...
  { codigo: '809660', nombre: 'PISTOLA ALTA PRESION KEW (ROJA)', stock: 9, categoria: 'equipo' },
  { codigo: '3P GUN', nombre: 'PISTOLA NEBULIZADORA', stock: 2, categoria: 'equipo' },
  { codigo: '804589', nombre: 'conexión racor KEW 1/4" rosca interior HEMBRA pipa', stock: 23, categoria: 'equipo' },
  { codigo: '1905202', nombre: 'ANIMAL', stock: 0, categoria: 'higiene' },
  { codigo: '1905201', nombre: 'ANIMAL 10 kg', stock: 44, categoria: 'higiene' },
  { codigo: '2506634/32', nombre: 'DIO CLEAN', stock: 198, categoria: 'higiene' },
  { codigo: '2509887', nombre: 'DRY CARE', stock: 904, categoria: 'higiene' },
  { codigo: '2509913', nombre: 'FOOD ALK', stock: 25, categoria: 'higiene' },
  { codigo: '2505283', nombre: 'HY BAG', stock: 0, categoria: 'higiene' },
  { codigo: '2505283BOX', nombre: 'HY BAG CAJA CON 12', stock: 273, categoria: 'higiene' },
  ...
  { codigo: '2505222', nombre: 'T&T', stock: 0, categoria: 'higiene' },
  { codigo: '2505277', nombre: 'TOP FOAM POWER', stock: 1334, categoria: 'higiene' },
  { codigo: 'TERMOFER', nombre: 'DESINFECTANTE TRMOFER 1 LT', stock: 26, categoria: 'otro' },
  { codigo: '8800425', nombre: 'Bomba Acid, 10 litros, 5 bar, 1 bar inyector', stock: 0, categoria: 'refaccion', specs: 'BOMBA DE MEMBRANA DOSIFICADORA PARA ACIDOS ORGANICOS' },
  { codigo: '8800457', nombre: 'Bomba Di-O-Clean, 10 litros, 5 bar', stock: 2, categoria: 'refaccion' },
  { codigo: '8800430', nombre: 'Cabezal de bomba K, Digi Doser Acid', stock: 0, categoria: 'refaccion', specs: 'REFACCION DE BOMBA DE MEMBRANA DOSIFICADORA DE ACIDOS' },
  { codigo: '8804514', nombre: 'Cabezal de bomba K, Digi Doser Di-O', stock: 4, categoria: 'refaccion', specs: 'ES UNA REFACCION PARA UNA BOMBA DE MEMBRANA (DIGI DOSER)' },
  { codigo: '8804578', nombre: 'Inyector Acid, 3 bar, 1/2" 4x6', stock: 5, categoria: 'refaccion', specs: 'RAFACCION DEL INYECTOR PARA LA BOMBA DE MEMBRANA DOSIFICADORA' },
  { codigo: '8804949', nombre: 'Kit reparación GreenLine', stock: 7, categoria: 'refaccion', specs: 'KIT DE O RING (EMPAQUES) PARA MANTENIMIENTO DE GEEN LINE' },
  { codigo: '200075552', nombre: 'MS Boquilla de baja presión', stock: 6, categoria: 'refaccion' },
  { codigo: '8800286', nombre: 'MS Control De Sequedad 72 Cm Digi Doser (Sensor de nivel)', stock: 1, categoria: 'refaccion' },
  { codigo: '8804535', nombre: 'Manguera de pres./asp. Digi Doser Di-O, 2 m', stock: 3, categoria: 'refaccion', specs: 'MANGUERA PARA INYECTOR DE BOMBA DE MEMBRANA DOSIFICADORA' },
  { codigo: '8804594', nombre: 'Manguera de presión Digi Doser, 2m 4x6', stock: 2, categoria: 'refaccion', specs: 'REFACCION MANGUERA DEL INYECTOR PARA BOMBA DE MEMBRANA DOSIFICADORA' },
  { codigo: '8800244', nombre: 'Pieza en T 90°, 40 x 1/2" x 40', stock: 2, categoria: 'refaccion', specs: 'T de PVC CON REDUUCION A 1/2' },
  { codigo: '8800610', nombre: 'Repartidor de señal con cable', stock: 2, categoria: 'refaccion', specs: 'REFACCION DE UNA MANGUERAPARA UNA BOMBA DE MENBRANA DE DOSIFICACION' },
  { codigo: '8804961', nombre: 'Tubo succión inox para Greenline', stock: 1, categoria: 'refaccion' },
];
