export const fancomProducts = [
  {
    codigo: "LUMINA 21",
    nombre: "Controlador LUMINA 21",
  ...
  {
    codigo: "MFC",
    nombre: "Sistema MFC (Mass Flow Control)",
  ...
  {
    codigo: "AURORA",
    nombre: "Sistema de Alimentación AURORA",
