        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <FadeInSection direction="left" className="order-2 lg:order-1">
            <div className="relative">
              ...
              <div className="relative aspect-[3/2] bg-gradient-to-br from-p3-blue to-p3-red rounded-2xl p-1">
                <div className="w-full h-full bg-white dark:bg-gray-800 rounded-2xl flex items-center justify-center p-6 sm:p-10">
